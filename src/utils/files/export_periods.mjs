    ...
    return [
        ...
        { text: 'SISTEMA WEB DE MONITOREO EDUCATIVO ENFOCADO A ÍNDICES DE REPROBACIÓN Y DESERCIÓN ESCOLAR', style: 'header' },
        {
            stack : [
                {
                    text: [
                        'Información de todos los periodos de la carrera ', {text: `${carrera}`, decoration: 'underline'},
        ...
        table: {
            ...
            body: [
                [
                    ...
                    { text: 'Reticula', style: 'tableHeader' },
...
export async function exportPeriods(data){
    return new Promise(async (resolve, reject) => {
        ...
        let content = [
            ...getHeaderAndLogos({carrera: carrera, date: date}),  // Use variables here
            getNewTable()
        ];
        ...
        data.forEach((item, index) => {
            if (index % 15 === 0 && index !== 0) {
                ...
                content.push(...getHeaderAndLogos({carrera: carrera, date: date}));  
